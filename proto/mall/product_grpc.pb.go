...
func (c *portalProductApiClient) SearchProduct(ctx context.Context, in *SearchProductReq, opts ...grpc.CallOption) (*SearchProductRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalProductApi_SearchProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalProductApiClient) CategoryTreeList(ctx context.Context, in *CategoryTreeListReq, opts ...grpc.CallOption) (*CategoryTreeListRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalProductApi_CategoryTreeList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalProductApiClient) ProductDetail(ctx context.Context, in *ProductDetailReq, opts ...grpc.CallOption) (*ProductDetailRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalProductApi_ProductDetail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPortalProductApiServer must be embedded to have
...
func (UnimplementedPortalProductApiServer) testEmbeddedByValue()                          {}
...
func RegisterPortalProductApiServer(s grpc.ServiceRegistrar, srv PortalProductApiServer) {
	// If the following call pancis, it indicates UnimplementedPortalProductApiServer was
