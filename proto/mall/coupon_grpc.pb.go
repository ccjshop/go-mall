...
func (c *portalCouponApiClient) CouponAdd(ctx context.Context, in *CouponAddReq, opts ...grpc.CallOption) (*CouponAddRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalCouponApi_CouponAdd_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalCouponApiClient) CouponListHistory(ctx context.Context, in *CouponListHistoryReq, opts ...grpc.CallOption) (*CouponListHistoryRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalCouponApi_CouponListHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalCouponApiClient) CouponList(ctx context.Context, in *CouponListReq, opts ...grpc.CallOption) (*CouponListRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalCouponApi_CouponList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalCouponApiClient) CouponListCart(ctx context.Context, in *CouponListCartReq, opts ...grpc.CallOption) (*CouponListCartRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalCouponApi_CouponListCart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalCouponApiClient) CouponListByProduct(ctx context.Context, in *CouponListByProductReq, opts ...grpc.CallOption) (*CouponListByProductRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalCouponApi_CouponListByProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPortalCouponApiServer must be embedded to have
...
func (UnimplementedPortalCouponApiServer) testEmbeddedByValue()                         {}
...
func RegisterPortalCouponApiServer(s grpc.ServiceRegistrar, srv PortalCouponApiServer) {
	// If the following call pancis, it indicates UnimplementedPortalCouponApiServer was
