...
type PortalMemberApiClient interface {
	// 会员注册
	MemberRegister(ctx context.Context, in *MemberRegisterReq, opts ...grpc.CallOption) (*MemberRegisterRsp, error)
	// 会员登录
...
func (c *portalMemberApiClient) MemberRegister(ctx context.Context, in *MemberRegisterReq, opts ...grpc.CallOption) (*MemberRegisterRsp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MemberRegisterRsp)
	err := c.cc.Invoke(ctx, PortalMemberApi_MemberRegister_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalMemberApiClient) MemberLogin(ctx context.Context, in *MemberLoginReq, opts ...grpc.CallOption) (*MemberLoginRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalMemberApi_MemberLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalMemberApiClient) MemberInfo(ctx context.Context, in *MemberInfoReq, opts ...grpc.CallOption) (*MemberInfoRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalMemberApi_MemberInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalMemberApiClient) MemberGetAuthCode(ctx context.Context, in *MemberGetAuthCodeReq, opts ...grpc.CallOption) (*MemberGetAuthCodeRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalMemberApi_MemberGetAuthCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalMemberApiClient) MemberUpdatePassword(ctx context.Context, in *MemberUpdatePasswordReq, opts ...grpc.CallOption) (*MemberUpdatePasswordRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalMemberApi_MemberUpdatePassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portalMemberApiClient) MemberRefreshToken(ctx context.Context, in *MemberRefreshTokenReq, opts ...grpc.CallOption) (*MemberRefreshTokenRsp, error) {
	...
	err := c.cc.Invoke(ctx, PortalMemberApi_MemberRefreshToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PortalMemberApiServer interface {
	// 会员注册
	MemberRegister(context.Context, *MemberRegisterReq) (*MemberRegisterRsp, error)
	// 会员登录
...
// UnimplementedPortalMemberApiServer must be embedded to have
...
func (UnimplementedPortalMemberApiServer) MemberRegister(context.Context, *MemberRegisterReq) (*MemberRegisterRsp, error) {
...
func (UnimplementedPortalMemberApiServer) testEmbeddedByValue()                         {}
...
func RegisterPortalMemberApiServer(s grpc.ServiceRegistrar, srv PortalMemberApiServer) {
	// If the following call pancis, it indicates UnimplementedPortalMemberApiServer was
