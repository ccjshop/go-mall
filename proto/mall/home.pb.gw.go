...
func request_PortalHomeApi_ProductCategoryList_0(ctx context.Context, marshaler runtime.Marshaler, client PortalHomeApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	protoReq.ParentId, err = runtime.Uint64(val)
	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "parentId", err)
	}

	msg, err := client.ProductCategoryList(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PortalHomeApi_ProductCategoryList_0(ctx context.Context, marshaler runtime.Marshaler, server PortalHomeApiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ProductCategoryListReq
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ProductCategoryList(ctx, &protoReq)
	return msg, metadata, err

}

// RegisterPortalHomeApiHandlerServer registers the http handlers for service PortalHomeApi to "mux".
// UnaryRPC     :call PortalHomeApiServer directly.
...
func RegisterPortalHomeApiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PortalHomeApiServer) error {
	...
	mux.Handle("GET", pattern_PortalHomeApi_ProductCategoryList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/admin.PortalHomeApi/ProductCategoryList", runtime.WithHTTPPathPattern("/home/productCateList/{parentId}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PortalHomeApi_ProductCategoryList_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PortalHomeApi_ProductCategoryList_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterPortalHomeApiHandlerFromEndpoint is same as RegisterPortalHomeApiHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterPortalHomeApiHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterPortalHomeApiHandler(ctx, mux, conn)
}

// RegisterPortalHomeApiHandler registers the http handlers for service PortalHomeApi to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterPortalHomeApiHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterPortalHomeApiHandlerClient(ctx, mux, NewPortalHomeApiClient(conn))
}

// RegisterPortalHomeApiHandlerClient registers the http handlers for service PortalHomeApi
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "PortalHomeApiClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "PortalHomeApiClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "PortalHomeApiClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterPortalHomeApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PortalHomeApiClient) error {
	...
	mux.Handle("GET", pattern_PortalHomeApi_ProductCategoryList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/admin.PortalHomeApi/ProductCategoryList", runtime.WithHTTPPathPattern("/home/productCateList/{parentId}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PortalHomeApi_ProductCategoryList_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
