...
func (c *smsAdminApiClient) CreateHomeAdvertise(ctx context.Context, in *AddOrUpdateHomeAdvertiseParam, opts ...grpc.CallOption) (*CommonRsp, error) {
	...
	out := new(CommonRsp)
	err := c.cc.Invoke(ctx, SmsAdminApi_CreateHomeAdvertise_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smsAdminApiClient) UpdateHomeAdvertise(ctx context.Context, in *AddOrUpdateHomeAdvertiseParam, opts ...grpc.CallOption) (*CommonRsp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommonRsp)
	err := c.cc.Invoke(ctx, SmsAdminApi_UpdateHomeAdvertise_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smsAdminApiClient) GetHomeAdvertises(ctx context.Context, in *GetHomeAdvertisesParam, opts ...grpc.CallOption) (*GetHomeAdvertisesRsp, error) {
	...
	err := c.cc.Invoke(ctx, SmsAdminApi_GetHomeAdvertises_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smsAdminApiClient) GetHomeAdvertise(ctx context.Context, in *GetHomeAdvertiseReq, opts ...grpc.CallOption) (*GetHomeAdvertiseRsp, error) {
	...
	err := c.cc.Invoke(ctx, SmsAdminApi_GetHomeAdvertise_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smsAdminApiClient) DeleteHomeAdvertise(ctx context.Context, in *DeleteHomeAdvertiseReq, opts ...grpc.CallOption) (*CommonRsp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommonRsp)
	err := c.cc.Invoke(ctx, SmsAdminApi_DeleteHomeAdvertise_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSmsAdminApiServer must be embedded to have
...
func (UnimplementedSmsAdminApiServer) testEmbeddedByValue()                     {}
...
func RegisterSmsAdminApiServer(s grpc.ServiceRegistrar, srv SmsAdminApiServer) {
	// If the following call pancis, it indicates UnimplementedSmsAdminApiServer was
