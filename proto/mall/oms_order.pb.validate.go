...
func (m *Order) validate(all bool) error {
	...
	// no validation rules for AutoConfirmDay
	...
	// no validation rules for PromotionInfo
	...
	// no validation rules for ReceiverPostCode

	// no validation rules for ReceiverProvince

	// no validation rules for ReceiverCity

	// no validation rules for ReceiverRegion

	// no validation rules for ReceiverDetailAddress
	...
	// no validation rules for UseIntegration
	...
	// no validation rules for BillHeader

	// no validation rules for BillContent

	// no validation rules for BillReceiverPhone

	// no validation rules for BillReceiverEmail
	...
	// no validation rules for CommentTime
	...
	for idx, item := range m.GetOrderOperateHistories() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, OrderValidationError{
						field:  fmt.Sprintf("OrderOperateHistories[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
